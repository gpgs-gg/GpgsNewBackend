...
const callingNumbers=leads.map(
x=>x.CallingNo
);
...
throw new ApiError(
400,
`${item.CallingNo} already exists today`
);

}


// next day update only
updateData.push({
...
count:
result.length+updateData.length,
